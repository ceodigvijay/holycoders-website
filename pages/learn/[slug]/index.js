...
export default function course() {
  ...
  if (!course) {
    ...
    return <Lesson courseMeta={courseMeta} setCourseMeta={setCourseMeta} course={course} setCourse={setCourse} />;
  } else {
    return (
      <CourseLayout
            ...
            <div className="flex justify-between">
              <div className="flex flex-1 flex-col justify-center pr-10">
                ...
                <div className="flex items-center">
                  ...
                  <span className="mx-2 font-bold text-blue-400">
                    Beginners
                  </span>
                </div>
                {/* Course Rating */}
                ...
                <button className="text-center mx-2 mt-20 bg-secondary rounded-full py-3 w-full px-10 text-white font-semibold">
                  Enroll for Free
                </button>
                <button className="text-center mx-2 mt-2 bg-gray-100 rounded-full py-3 w-full px-10 text-gray-700 font-semibold">
