        ...
        <section>
          ...
          <nav className="main-nav navbar is-primary">
            <div className="container">
              <div className="navbar-start ">
                ...
                >
                  <img
                    src="/bulmaswatch/assets/icons/apple-touch-icon-144x144.png"
                    alt=""
                    className="logo"
                  />
                  <h1 className="title is-5">Bulmaswatch</h1>
                </a>
                <a
                  className="navbar-item "
                  href="https://jenil.github.io/bulmaswatch/"
                ...
                <a
                  className="navbar-item "
                  href="https://jenil.github.io/bulmaswatch/help/"
                >
                  Help
                </a>
              </div>
          ...
          <div className="hero is-primary">
            <div className="hero-body">
              <div className="container">
                <h1 className="title">Darkly</h1>
                <h2 className="subtitle">Flatly in night-mode</h2>
                <p>
                  <a
                    className="button is-primary is-inverted"
                    href="/bulmaswatch/darkly/bulmaswatch.min.css"
                    target="_blank"
                    onclick="ga('send', 'event', 'theme', 'download', 'Darkly');"
                  >
                    Download
                  </a>
                  <a
                    className="button is-dark"
                    href="//github.com/jenil/bulmaswatch/tree/gh-pages/darkly"
                    target="_blank"
                    onclick="ga('send', 'event', 'theme', 'github', 'Darkly');"
          ...
          <div className="container">
            <div className="content has-text-centered">
              ...
              <p>
                ...
                <a href="https://jgog.in" target="_blank">
                  Jenil Gogari
                </a>
                .
                <br /> Based on
                <a
                  href="https://bulma.io"
                  target="_blank"
                  onclick="ga('send', 'event', 'footer', 'click', 'bulma');"
                >
                  Bulma
                </a>
                . Icons from
                <a
                  ...
                  target="_blank"
                  onclick="ga('send', 'event', 'footer', 'click', 'font-awesome');"
                >
                  Font Awesome
                </a>
                . Web Fonts from
                <a
                  ...
                  target="_blank"
                  onclick="ga('send', 'event', 'footer', 'click', 'google');"
                >
                  Google
                </a>
                .
