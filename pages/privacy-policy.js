    ...
    <Layout>
      ...
      <div className="prose dark:prose-dark md:prose-lg lg:prose-xl mx-auto my-6 px-2">
        <p>
          ...
          by HolyCoders and how we use it. If you have additional questions or
          require more information about our Privacy Policy, do not hesitate to
          contact us.
        </p>
        <h2 className="title is-2 my-6">
          General Data Protection Regulation (GDPR)
        </h2>
        <p>We are a Data Controller of your information.</p>
        <p>
          HolyCoders legal basis for collecting and using the personal
        ...
        <ul>
          <li>HolyCoders needs to perform a contract with you</li>
          <li>You have given HolyCoders permission to do so</li>
          <li>
            Processing your personal information is in HolyCoders legitimate
            interests
          </li>
          <li>HolyCoders needs to comply with the law</li>
        </ul>
        <p>
          HolyCoders will retain your personal information only for as long as
        ...
        <h2 className="title is-2 my-6">Log Files</h2>
        <p>
          HolyCoders follows a standard procedure of using log files. These
        ...
        <h2 className="title is-2 my-6">Cookies and Web Beacons</h2>
        <p>
          Like any other website, HolyCoders uses ‘cookies’. These cookies are
        ...
        <h2 className="title is-2 my-6">Google DoubleClick DART Cookie</h2>
        <p>
        ...
        <h2 className="title is-2 my-6">Our Advertising Partners</h2>
        <p>
        ...
        <h2 className="title is-2 my-6">Privacy Policies</h2>
        <p>
          You may consult this list to find the Privacy Policy for each of the
          advertising partners of HolyCoders.
        </p>
        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on HolyCoders, which are sent
        ...
        <p>
          Note that HolyCoders has no access to or control over these cookies
          that are used by third-party advertisers.
        </p>
        <h2 className="title is-2 my-6">Third-Party Privacy Policies</h2>
        <p>
          HolyCoders’s Privacy Policy does not apply to other advertisers or
        ...
        <h2 className="title is-2 my-6">Children’s Information</h2>
        <p>
        ...
        <p>
          HolyCoders does not knowingly collect any Personal Identifiable
          Information from children under the age of 13. If you think that your
          child provided this kind of information on our website, we strongly
          encourage you to contact us immediately and we will do our best
          efforts to promptly remove such information from our records.
        </p>
        <h2 className="title is-2 my-6">Online Privacy Policy Only</h2>
        <p>
          Our Privacy Policy applies only to our online activities and is valid
          for visitors to our website with regards to the information that they
          shared and/or collect in HolyCoders. This policy is not applicable to
          any information collected offline or via channels other than this
          website.
        </p>
        <h2 className="title is-2 my-6">Consent</h2>
        <p>
