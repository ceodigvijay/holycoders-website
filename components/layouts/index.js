        ...
        <div className="has-text-centered has-text-white">
          ...
          <div className="columns">
            <div className="column">
              <h4 className="title is-4 has-text-white">About Us</h4>
            ...
            <div className="column">
              <h4 className="title is-4 has-text-white">Important</h4>
              <ul>
                <li>
                  <a href="#">Link</a>
                </li>
            ...
            <div className="column">
              <h4 className="title is-4 has-text-white">Subscribe</h4>
